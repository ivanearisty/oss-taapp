...
class TestGmailClientCoreMethods:
    ...
    def test_get_message_success(self):
        ...
        mock_message = Mock()
        with patch('gmail_client_impl._impl.message.get_message', return_value=mock_message) as mock_factory:
            # ACT
    ...
    def test_get_message_no_raw_content(self):
    ...
    def test_get_message_api_exception(self):
    ...
    def test_delete_message_api_exception(self):
    ...
    def test_mark_as_read_api_exception(self):
    ...
    def test_get_messages_success(self):
        ...
        with patch('gmail_client_impl._impl.message.get_message', side_effect=[
            mock_message_1, mock_message_2, mock_message_3
        ]) as mock_factory:
            # ACT
    ...
    def test_get_messages_message_without_id(self):
    ...
    def test_get_messages_message_without_raw_content(self):
        ...
        with patch('gmail_client_impl._impl.message.get_message', return_value=mock_message_1) as mock_factory:
            # ACT
            messages = list(self.client.get_messages())
    ...
    def test_get_messages_default_max_results(self):
