...
class TestGmailClientAuthentication:
    ...
    def test_init_with_provided_service_skips_auth(self, mock_build):
    ...
    def test_init_with_env_vars_success(self, mock_request, mock_creds_class, mock_build):
    ...
    def test_init_with_custom_token_uri(self, mock_request, mock_creds_class, mock_build):
    ...
    @patch("gmail_client_impl._impl.Credentials")
    def test_init_with_token_file_success(self, mock_creds_class, mock_path, mock_build):
    ...
    @patch("gmail_client_impl._impl.Credentials")
    @patch("gmail_client_impl._impl.Request")
    def test_init_token_file_needs_refresh(self, mock_request, mock_creds_class, mock_path, mock_build):
    ...
    @patch("gmail_client_impl._impl.build")
    def test_init_interactive_mode_forces_flow(self, mock_build):
    ...
    @patch("gmail_client_impl._impl.build")
    def test_build_service_failure(self, mock_build):
...
class TestGmailClientHelperMethods:
    ...
    @patch("gmail_client_impl._impl.Path")
    def test_run_interactive_flow_success(self, mock_path, mock_flow_class):
    ...
    @patch("gmail_client_impl._impl.Path")
    def test_run_interactive_flow_missing_credentials(self, mock_path):
    ...
    @patch("gmail_client_impl._impl.InstalledAppFlow")
    @patch("gmail_client_impl._impl.Path")
    def test_run_interactive_flow_exception(self, mock_path, mock_flow_class):
...
class TestGmailClientConstants:
    ...
    def test_scopes_constant(self):
        ...
        assert GmailClient.SCOPES == expected_scopes

    def test_failure_message_constant(self):
        """Test that failure message constant is defined."""
        assert GmailClient.FAILURE_TO_CRED == "Failed to obtain credentials. Please check your setup."
