...
class TestServiceClientAdapter:
    ...
    def test_get_message_success(self, mock_get_message):
        ...
        mock_get_message.assert_called_once_with(
            message_id="msg123",
            client=self.mock_service_client
        )
    ...
    @patch('mail_client_adapter.service_client_adapter.get_message_sync')
    def test_get_message_exception(self, mock_get_message):
    ...
    @patch('mail_client_adapter.service_client_adapter.delete_message_sync')
    def test_delete_message_failure(self, mock_delete_message):
    ...
    def test_mark_as_read_success(self, mock_mark_as_read):
    ...
    @patch('mail_client_adapter.service_client_adapter.mark_as_read_sync')
    def test_mark_as_read_failure(self, mock_mark_as_read):
    ...
    @patch('mail_client_adapter.service_client_adapter.mark_as_read_sync')
    def test_mark_as_read_exception(self, mock_mark_as_read):
    ...
    def test_get_messages_success(self, mock_list_messages):
    ...
    @patch('mail_client_adapter.service_client_adapter.list_messages_sync')
    def test_get_messages_with_limit(self, mock_list_messages):
        ...
        # Call with limit
        messages = list(self.adapter.get_messages(max_results=3))

        # Verify only 3 messages were returned
        assert len(messages) == 3

    @patch('mail_client_adapter.service_client_adapter.list_messages_sync')
    def test_get_messages_empty(self, mock_list_messages):
    ...
    @patch('mail_client_adapter.service_client_adapter.list_messages_sync')
    def test_get_messages_exception(self, mock_list_messages):
