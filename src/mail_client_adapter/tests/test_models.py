...
class TestListMessagesResponse:
    ...
    def test_list_messages_response_initialization(self):
    ...
    def test_list_messages_response_to_dict(self):
    ...
    def test_list_messages_response_empty_list(self):
    ...
    def test_list_messages_response_single_item(self):
    ...
    def test_list_messages_response_data_mutation(self):
...
class TestGetMessageResponse:
    ...
    def test_get_message_response_initialization(self):
    ...
    def test_get_message_response_to_dict(self):
    ...
    def test_get_message_response_empty_dict(self):
    ...
    def test_get_message_response_data_mutation(self):
        """Test that modifying the original data affects the response (no copying)."""
...
class TestDeleteMessageResponse:
    ...
    def test_delete_message_response_initialization(self):
    ...
    def test_delete_message_response_to_dict(self):
    ...
    def test_delete_message_response_with_different_data_types(self):
    ...
    def test_delete_message_response_failure(self):
...
class TestMarkAsReadResponse:
    ...
    def test_mark_as_read_response_initialization(self):
    ...
    def test_mark_as_read_response_to_dict(self):
    ...
    def test_mark_as_read_response_with_different_data_types(self):
    ...
    def test_mark_as_read_response_failure(self):
    ...
    def test_mark_as_read_response_data_mutation(self):
        """Test that modifying the original data affects the response (no copying)."""
...
class TestModelClassesGeneral:
    ...
    def test_all_models_have_data_attribute(self):
    ...
    def test_all_models_have_to_dict_method(self):
    ...
    def test_models_with_none_data(self):
    ...
    def test_models_to_dict_with_none_data(self):
