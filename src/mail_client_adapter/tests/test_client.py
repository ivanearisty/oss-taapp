...
from mail_client_adapter.client import Client, AuthenticatedClient
...
class TestClient:
    ...
    @patch('httpx.Client')
    def test_get_httpx_client_creates_new(self, mock_httpx_client_class):
    ...
    def test_get_httpx_client_returns_existing(self):
    ...
    def test_get_async_httpx_client_creates_new(self, mock_async_client_class):
    ...
    def test_get_async_httpx_client_returns_existing(self):
...
class TestAuthenticatedClient:
    ...
    def test_authenticated_client_initialization_with_custom_auth(self):
    ...
    @patch('httpx.Client')
    def test_get_httpx_client_creates_new_with_auth(self, mock_httpx_client_class):
    ...
    @patch('httpx.Client')
    def test_get_httpx_client_with_custom_auth(self, mock_httpx_client_class):
    ...
    @patch('httpx.Client')
    def test_get_httpx_client_with_empty_prefix(self, mock_httpx_client_class):
    ...
    @patch('httpx.AsyncClient')
    def test_get_async_httpx_client_creates_new_with_auth(self, mock_async_client_class):
