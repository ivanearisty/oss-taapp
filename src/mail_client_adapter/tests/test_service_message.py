...
class TestServiceMessage:
    ...
    def test_service_message_initialization(self):
    ...
    def test_service_message_with_missing_fields(self):
    ...
    def test_service_message_with_empty_data(self):
    ...
    def test_service_message_with_extra_fields(self):
    ...
    def test_service_message_properties_are_readonly(self):
    ...
    def test_service_message_with_special_characters(self):
    ...
    def test_service_message_inheritance(self):
    ...
    def test_service_message_data_storage(self):
    ...
    def test_service_message_with_unicode(self):
